...
#https://pubs.acs.org/doi/full/10.1021/acs.jpclett.2c01463 Paul2022
...
for n,file in enumerate(cubeDirNames):
    ...
    try:
        ...
        ax.scatter(my_cubic_size[n]*np.ones_like(OS[0,2]), OS[0,2], c = "Black", marker = 'd', alpha=1)
        ax.scatter(my_cubic_size[n]*np.ones_like(OS[1:3,2]), OS[1:3,2], c ='Red', marker = 'd', alpha=1)
...
#plt.show()
plt.savefig("OrthoOS.png", dpi=300, bbox_inches='tight')
