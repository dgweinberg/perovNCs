...
void Hmat(zomplex *psi,zomplex *phi,MKL_Complex16 *psitot,double *potl,double *ksqr,double *eval,long_st ist,par_st par,nlc_st *nlc,long *nl,fftw_plan_loc planfw,fftw_plan_loc planbw,fftw_complex *fftwpsi)
{
  FILE *pg;
  long ims, jms, jgrid;
