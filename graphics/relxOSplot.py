...
cubeFileDir = "/home/dweinberg/Projects/rashba/calcs/production2/relax/"
rectFileDir = "/home/dweinberg/Projects/rashba/calcs/production2/relax/"
...
for n,file in enumerate(cubeDirNames):
    ...
    try:
        ...
        ax.scatter(my_cubic_size[n]*np.ones_like(OS[0,2]), OS[0,2], c = "Black", marker = 'o', alpha=1)
        ax.scatter(my_cubic_size[n]*np.ones_like(OS[1:3,2]), OS[1:3,2], c ='Red', marker = 'o', alpha=1)
...
ax.set_ylim(ymax = 3.5, ymin = 1.5)
plt.xlim(xmax = 10, xmin = 1)
ax.set_title("Excitation Energy")
#plt.show()
fig.savefig("RelaxedOS.png", dpi=300, bbox_inches='tight')
